...
class OrderServiceApplicationTests {
    ...
    // Cannot instantiate @InjectMocks field named 'inventoryClient'! Cause: the type 'InventoryClient' is an interface.
    // Because of this inventoryClient with Annotation @MockBean is causing error and giving and
    // setting false for every wiremock inventory-service stub even if we set true it will set false
    @MockBean
